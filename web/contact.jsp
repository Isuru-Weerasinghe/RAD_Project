...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Inspira Ella-Contact</title>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <h5>Get In Touch</h5>
                        <p class="mb-4">
                            We would love to hear from you! For any inquiries, feedback, or assistance, please don't hesitate to reach out to our friendly team.</p>
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="mb-0">Inspira Ella, 1st Lane, Sapumalthena, Ella, 90900 Ella, Sri Lanka</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-4">
                            <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="mb-0">info@inspiraella.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <iframe class="position-relative rounded w-100 h-100"
                                src="https://storage.googleapis.com/maps-solutions-aynlcq8a2j/locator-plus/fnkx/locator-plus.html"
                    ...
                    <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                        <form action="contactformProcess.jsp" method="POST">
                            <div class="row g-3">
                                <div class="col-md-6">
